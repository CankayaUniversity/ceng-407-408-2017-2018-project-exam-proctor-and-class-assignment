<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PasswordSettings.aspx.cs"
    Inherits="settings_PasswordSettings" %>
...
<head>
    ...
    <script type="text/javascript">
        function btnSaveClick() {
            ...
            var configPassword = $("#txtConfigPassword").val();

            var obj = {};
            obj.oldPassword = oldPassword;
            obj.newPassword = newPassword;
            obj.configPassword = configPassword;
            $.ajax({
                type: "POST",
                url: "PasswordSettings.aspx/btnSaveClick",
							...
							<div class="m-stack__item m-stack__item--fluid m-header-menu-wrapper">
								...
								<div id="m_header_menu" class="m-header-menu m-aside-header-menu-mobile m-aside-header-menu-mobile--offcanvas  m-header-menu--skin-dark m-header-menu--submenu-skin-light m-aside-header-menu-mobile--skin-light m-aside-header-menu-mobile--submenu-skin-light "  >
									<ul class="m-menu__nav  m-menu__nav--submenu-arrow ">
                                        <li class="m-menu__item  m-menu__item--submenu m-menu__item--tabs"  data-menu-submenu-toggle="tab" aria-haspopup="true">											<a  href="../Homepage.aspx" class="m-menu__link m-menu__toggle">
                                        ...
                                        <table class="table table-hover" id="table">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th  align="right">                                                       
                                                        <input class="form-control m-input" runat="server" type="password" value="" id="txtOldPassword" style="width:250px" placeholder="old password">
                                                    </th>
                                                ...
                                                <tr>
                                                    ...
                                                    <th>
                                                        <input class="form-control m-input" runat="server" type="password" value="" id="txtNewPassword" style="width:250px" placeholder="new password">
                                                ...
                                                <tr>
                                                    ...
                                                    <th>
                                                        <input class="form-control m-input" runat="server" type="password" value=""  id="txtConfigPassword" style="width:250px" placeholder="config password">
                                                    </th>
                                       
                                                </tr>
                                                 <tr>
                                                    <th>
                                                        <button class="btn btn-primary" type="button" id="btnSave" runat="server"  onclick ="btnSaveClick();">
															Save
														</button>
                                                    </th>
                                                    <th>
